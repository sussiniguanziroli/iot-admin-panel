...
const Dashboard = () => {
    ...
    // State for Tenant Switcher (Super Admin Only)
    ...
    return (
        <div className="max-w-7xl mx-auto pb-20">
            ...
            {/* 1. SUPER ADMIN SWITCHER (TENANTS) */}
            ...
            {/* 2. LOCATION SWITCHER (Available to everyone if multiple locations exist) */}
            {locations.length > 0 && (
                <div className="mb-6 flex items-center gap-4 bg-white dark:bg-slate-800 p-2 pl-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="relative group">
                        <select 
                            ...
                            className="appearance-none bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-white pl-4 pr-10 py-2 rounded-lg font-bold cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-700 outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                        >
                            {locations.map(loc => (
            ...
            {machines.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-dashed border-slate-300 dark:border-slate-700">
                    ...
                    {isEditMode && locations.length > 0 && (
                         <button onClick={() => setIsMachineModalOpen(true)} className="mt-6 bg-blue-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-700">
