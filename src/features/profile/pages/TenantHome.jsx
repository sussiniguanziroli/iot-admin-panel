// src/features/profile/pages/TenantHome.jsx
...
const TenantHome = () => {
  ...
  const planName = billingData?.subscription?.plan || 'Free';
  const daysLeft = billingData?.subscription?.currentPeriodEnd 
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-blue-100 text-lg mb-6">
            Organization: <span className="font-bold">{userProfile?.tenantId?.replace(/-/g, ' ').toUpperCase()}</span>
          </p>
