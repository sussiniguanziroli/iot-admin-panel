...
const WidgetConfigModal = ({ isOpen, onClose, onSave, widget = null, machineId }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.dataKey.trim()) {
            toast.error('Data key is required', { position: 'top-right', autoClose: 3000 });
            return false;
        }
                                    ...
                                    <div className="grid grid-cols-4 gap-2 mb-4">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`py-2 px-3 text-xs font-bold rounded-lg border-2 transition-all ${formData.commandFormat === format.value
